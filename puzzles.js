const puzzles = [
        ...
        levels: [
            {
                ...
                description: `Welcome to <b style="color: red;">Red Pixel Simulator</b>!<br>&emsp;<b style="color: red;">Red Pixel Simulator</b> is a sandbox-puzzle game based solely on interactions between some numbers in a grid. (Almost) everything is completely deterministic based on simple interactions between pixels. For the purposes of the puzzles, your goal is to <b>defeat all the monsters</b> (the red things with faces) by destroying them using other pixels and to <b>move the goal pixels</b> <b>to the targets</b>. For now, we will stick with just monsters.<br><br>&emsp;On the <b>left of your screen is the grid</b>. <b>On the right is the sidebar</b>, which contains all of the game controls. At the top, there is the <b>Pixel Picker</b>. Here you can see what and how many pixels you can place; you can <b>select them by clicking on them</b>. Below that, there are controls for your <b>brush size (up and down arrows)</b> and <b>simulation control</b>: You can <b>pause</b>, <b>warp</b>, and <b>step</b> the simulation. You can also turn on <b>slowmode</b>, which is useful in puzzles where things move so fast you can't see them.<br><br>&emsp;At the bottom of the sidebar (scroll ALL THE WAY DOWN) you can find all the controls available.</b><br><br>&emsp;The levels after the following tutorial levels were <b>designed to be challenging</b>. They take the taught mechanics of the simulation and stretch them to their limits. <b>If you ever get stuck, don't worry. Just try a different level or section</b>, as there's no set difficulty progression.<br><br><b>Let's get started! Go down and press the <h>run</h> button (it looks like a play button) to begin.</b>`,
            ...
            {
                name: 'Gravity',
                description: `&emsp;Although everything is, at its core, a grid of numbers, gravity still applies. Pixels like <b>dirt</b>, <b>sand</b>, <b>water</b>, and many more will <b>fall downwards</b> when given the chance to. Some are more flowy than others. <b>Water is... watery</b>, and flows until it can't find a lower spot. <b>Pixels like dirt and sand will form hills</b> of different slopes, depending on the pixel.<br>&emsp;When a pixel destroys a monster, <b>it also gets destroyed</b>. Keep that in mind in later puzzles.<br><br><b>Place sand, dirt, and water in the non-shaded area to destroy the monsters!</b><br><i><b>You cannot place pixels in the shaded areas.</b></i><br><b>You have one of each pixel</b>, and <b>you cannot edit after starting the simulation</b>.<br>Use the <h>reset</h> button to revert to before the simulation began.`,
            ...
            {
                name: 'Mudslide',
                description: `Oh no! Your only pixels are <b>wood</b>, which doesn't fall. Don't worry, though, because you can use that wood to <b>redirect the water</b>. It may seem like this challenge is impossible, but there is another way.<br><br><b>Water turns dirt into mud when it touches it</b> - you can use this to your advantage by <b>creating a mudslide</b>.`,
            ...
            {
                name: 'Lava',
                description: `It appears that the monsters are learning. They've built a barrier of wood to protect themselves from falling pixels. However, they failed to neglect the fact that you have rather conveniently been given lava for this puzzle.<br><br><b>Lava can set stuff on fire, use it to burn through their barriers.</b>`,
            ...
            {
                name: 'Breaking Game',
                description: `There's plenty of lava to destroy the monsters, but they've built a water trough to stop the lava and you only have some <b>kitchen sponges and that weird plant you found growing on your basement floor</b>. Wait, is that a <i>vault</i> that that monster's sealed itself in? You should be able to do this, though, you'll find a way.`,
            ...
            },
            {
                ...
                description: `How strange, the Aether is real! Anyways, you only have a few pixels to use. <b>Choose wisely!</b>`,
            ...
            {
                name: 'Platformer',
                description: `Well, the monsters have built themselves a platform up to an unplaceable area. Unfortunately for them, they've <b>made it out of wood</b>. Find a way to get them down!`,
    ...
    },
    {
        ...
        levels: [
            ...
            },
            {
                ...
                description: `If this isn't the Amazon and it's definitely not the Sahara, and we just passed through a massive canyon, where are we? Speaking of Sahara, you should - MONSTER! KILL IT! <b>AAAAAAAAAAAAAAAAAAAAAA!!!</b>`,
    ...
    },
    {
        ...
        levels: [
            {
                name: 'Pushy Pushers',
                description: `These pixels can <b>move on their own</b>, I wonder if you can make a computer with them. Oh, by the way, watch out for the gunpowder.`,
            ...
            },
            {
                ...
                description: `Oh cool, we can rotate stuff now. Well, I already knew that. Anyways, you only have <b>rightwards pushers</b>, <b>clockwise rotators</b>, and <b>rightwards rotators</b>. And a <b>wall</b>, which is immovable. <i>Use the existing rotators to your advantage.</i><br><br><b>The rotators with spinning textures will rotate pixels in their direction, and the static ones will rotate pixels to face the same way as them.</b>`,
            ...
            },
            {
                ...
                description: `There's those <b>goal</b> (gold) and <b>target</b> (cyan) pixels I alluded to earlier. You must <b>push the goal pixels into the targets to win</b>. Those yellow-orange pixels with horizontal and vertical lines are <b>sliders</b>- They <b>can only be pushed along one axis</b> and <b>can be rotated</b>, perhaps that will be useful here.<br><br><i>Remember, when in doubt, do random stuff and see what happens!</i>`,
            ...
            },
            {
                ...
                description: `Instead of breaking the game, in this puzzle you'll be <b>breaking the laws of thermodynamics!</b> The pixels with blue and yellow arrows are <b>copiers</b>, and they... copy. These pixels here are special copiers called <b>cloners</b>; they are like copiers, but they can <b>push pixels</b> to make space for the mass it creates in violation of the laws of thermodynamics.<br><br><b><i>Some pixels are not cloneable, for example, goal pixels.</i></b>`,
            ...
            },
            {
                ...
                description: `Hmmm, you have <b>multiple goals</b> to deliver now, but they all have to be moved at the same time? <i>This one's a tricky one, I'll give you that.</i>`,
            ...
            {
                name: 'Green Lasers',
                description: `Green lasers are bad for your health, and they're especially bad for pixels. Luckily, you have <b>laser scatterers, which scatters the laser beam into harmless green light</b>. Give it a try.`,
            ...
            {
                name: 'Placement Test',
                description: `You have very limited options in terms of placement locations here. <b>Choose carefully!</b>`,
            ...
            {
                name: 'Reflection',
                description: `Ah, a simple puzzle. Makes for a nice break from the brain-breaking machines. Anyways, those diagonal thingies are <b>mirrors</b>. <b>Mirrors reflect lasers</b>, so you can use this to redirect them to your targets. More interesting is that you have even numbers of everything (except mirrors).<br><br>Alright, I'm off to work on the PixSim API and think about the faults of society. And maybe make some music too.`,
            ...
            {
                name: 'Chaos',
                description: `Oh wow, that's a lot of stuff. You've got <b>copiers</b> now, too. Well... good luck, this one took me a while to figure out. It's a messy one.`,
            ...
            {
                name: 'Danger Zone',
                description: `Careful! Those purple glowy thingies are <b>deleters</b>- They delete stuff! One wrong move and everything is gone. Well, you can always <b>reset if that happens</b>.<br>The orange-ish boxes with a diagonal are <b>collapsible boxes, they can be crushed when pushed into something</b>.`,
            ...
            {
                name: 'Sticky Slime',
                description: `Well, I guess we have <b>slime</b> now...<br>Buh. This looks impossible. Oh well, good luck lol<br><br><i>Level credit: sp</i>`,
            ...
            },
            {
                ...
                description: `Oh no, not this one again! It's like that other one but even worse! And there's clay blocking the final tunnel! Well, those <b>sticky pushers</i> will probably come in handy.<br><br><i>Level credit: sp</i>`,
